                  ...
                  <div class="card-header">
                       ...
                       <table class="table table-sm table-striped">
                        ...
                        <tbody>
                          <tr v-for="card in cards" :key="card.id">
                            <th>{{ card.pro_name }}</th>
                            <td><textarea type="text" class="form-control" required="" @change="detailsadd($event,card.id)"  :value="card.details"></textarea></td>
                    ...
                    <form @submit.prevent="orderdone">
                      ...
                      <select class="form-control" v-model="customer_id">
                         <option :value="customer.id" v-for="customer in customers">{{ customer.name }} ({{ customer.phone }})</option>
                      </select>
                      ...
                      <input type="text" class="form-control"  required="" v-model="deliverycharge">

                      <label>Pay By </label>
                      <select class="form-control" v-model="payby">
                         <option value="HandCash" selected>Hand Cash</option>
    ...
    export default {
      mounted(){
        ...
        /* onChange(event) {
            ...
            //this.due= this.subtotal-event.target.value;
        ...
        methods:{
          ...
          orderdone(){
            ...
            var data = {qty:this.qty, subtotal:this.subtotal,deliverycharge:this.deliverycharge, customer_id:this.customer_id, payby:this.payby, pay:this.pay, due:this.due, vat:this.vats.vat, total:total}
